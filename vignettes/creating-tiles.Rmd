...
# Upload the generated tileset to your Mapbox account (requires a Mapbox secret
...
# `check_upload_status()`) and add it to a style.  When you've styled it, bring
# it back into R with mapdeck by referencing the style ID:
